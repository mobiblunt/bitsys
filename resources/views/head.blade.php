...
<link rel="shortcut icon" href="images/favicon.png">
    ...
    <body>
        ...
        <div class="sidebar" data-color="blue" data-image="{{ url('/') }}/img/sidebar-1.jpg">
            ...
            <div class="logo">
                <img class="img-responsive" width="200" height="200" src="{{ url('/') }}/styles/assets/images/logo.png" alt="">
        ...
        <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">Bitcoin System</a>
                    </p>
                </div>
            </footer>
        </div>
