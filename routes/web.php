...
Route::get('support', 'DashiController@contact')->name('contact.home');
//Route::get('privacy', 'DashiController@privacy')->name('privacy.home');
Route::get('plans', 'DashiController@robots')->name('robots.home');
Route::get('faq', 'DashiController@steps')->name('steps.home');
